...
namespace gim.Content.Items.Consumables
{
    public class GimPotion : ModItem
    {
        ...
        {
            Tooltip.SetDefault("An amalgamation of a large amount of potions\nGrants Inferno, Endurance, Thorns, Lifeforce, Wrath, Rage, Ironskin, Regeneration, and Swiftness buffs");
        }
